...
flags.DEFINE_string('checkpoint_dir', '/home/elebouder/repos/models/research/object_detection/tmp',
                    'Directory containing checkpoints to evaluate, typically '
                    'set to `train_dir` used in the training job.')
flags.DEFINE_string('eval_dir', '/home/elebouder/repos/models/research/object_detection/tmp/eval',
